...
These scripts live in the Obsidian Vault at `SKI_Bootstrap_Opus/` and are accessible from both the Host and the VM.
...
| Location | Path |
|----------|------|
| Host (Windows) | `D:\28Bots_Core\Obsidian_Vault\root\SKI_Bootstrap_Opus\` |
| VM (Ubuntu) | `/mnt/28bots_core/Obsidian_Vault/SKI_Bootstrap_Opus/` |
| Repo | `vault/SKI_Bootstrap_Opus/` |
